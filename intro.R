...
to provide you with a <font color=#1f7a1f> simple-to-use </font> and 
<font color=#1f7a1f> simple-to-understand </font> application 
regarding <font color=#1f7a1f> worldwide location distribution 
</font> and <font color=#1f7a1f>nutritional information</font>. Our 
<font color#1f7a1f><strong> goal </strong></font> is to provide 
you, the user, with new insights about Starbucks.
</h4>
<h4>
The following interactive pages will be providing you with 
widely <font color=#1f7a1f> adjustable visualizations</font>.
...
intro2 <- paste0("<h4>
                 This project is targeted towards <font color=#1f7a1f>Starbucks
                 ...
                 color=#1f7a1f> not licensed</font>, which can be a concern for some 
                 consumers. Our map is able to display <font color=#1f7a1f></font>, 
                 which can be a concern for some 
                 consumers. Our map is able to display <font color=#1f7a1f>the 
...
intro3 <- "<h4>
<font color=#1f7a1f>Curious about the distributions of Starbucks
...
<font color=#1f7a1f>total number of Starbucks</font> in that 
...
intro4 <- "<h4>
We've implemented tables of the <font color=#1f7a1f>entire food 
and drink menu</font>, including some general and specified plots,
<font color=#1f7a1f>all</font> of which are <em>interactive</em>.
Meaning, that you can <font color=#1f7a1f>pick and choose</font> the 
...
<h4>
Perhaps your menu item of interest has <font color=#1f7a1f>too much
...
<font color=#1f7a1f>simplicity</font> of utilizing our tables 
